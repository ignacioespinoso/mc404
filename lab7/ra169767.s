...
@ -- Encontra o n-esimo numero da sequencia de fibonacci
		@move a quantidade de iteracoes para o registrador r3
		mov r3, r0
		@r1 armazena o numero anterior, r0 o numero atual.
		mov r0, #1
		mov r1, #0
loop_fibonacci:
	cmp r3, #1		@Caso tenham sido feitas todas as iteracoes, sai do loop
	bls fim_loop

	mov r2, r0		@Salva o ultimo valor temporariamente em r2
	add r0, r0, r1 	@Atualiza o ultimo valor
	mov r1, r2		@Atualiza o valor anterior
	sub r3, r3, #1 @Atualiza o iterador
	b loop_fibonacci
fim_loop:
