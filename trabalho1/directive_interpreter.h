...
bool apply_word(int *address, char *directive_parameter, char **memory_map
								, Label_list label_head_node, Alias_list alias_head_node
								, bool *be_printed, int line_counter, FILE *output);
...
bool apply_set(Alias_list head_node, char *directive_parameter, char **string_end
								, Label_list label_head_node, int line_counter, FILE *output);
